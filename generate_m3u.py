...
# Kategoriler
CATEGORIES = {
    "Ulusal": ["trt 1", "atv", "show", "star", "kanal d", "fox", "tv8", "beyaz", "teve2", "haberturk", "cnn turk", "ntv", "tv100", "a2", "kanal 7", "360", "tlc", "bloomberg ht", "a haber", "trt haber", "tv 100", "ulke tv", "tgrt haber"],
    "Spor": ["spor", "sport", "bein", "s sport", "tivibu", "aspor", "trt spor", "fb tv", "gs tv", "bjk tv", "eurosport", "nba", "f1", "tivibu spor", "sports tv"],
    "Belgesel": ["belgesel", "discovery", "nat geo", "national geo", "history", "trt belgesel", "yaban", "bbc earth", "animal planet", "da vinci learning"],
    "Sinema": ["sinema", "movie", "film", "dizi", "blu", "moviebox", "cinemax", "hbo", "fox movies", "filmbox", "fx", "salon", "dizi tv"],
    "Haber": ["haber", "news", "cnn", "ntv", "a haber", "trt haber", "ulke", "tgrt", "24", "bloomberg", "haber global", "tvnet"],
    "Çocuk": ["çocuk", "cocuk", "cartoon", "disney", "nickelodeon", "trt çocuk", "minika", "baby", "kid", "nick jr", "boomerang", "minika go"],
    "Müzik": ["müzik", "muzik", "music", "kral", "powerturk", "power", "number one", "trt müzik", "dream", "mtv", "vh1", "kral pop"],
}
